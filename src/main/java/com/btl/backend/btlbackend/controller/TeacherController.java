...
import com.btl.backend.btlbackend.service.TeacherService;
...
public class TeacherController extends BaseController<TeacherDTO, TeacherService> {
    ...
    @Override
    public ResponseEntity<ResponseMsg> create(@RequestBody TeacherDTO dto) {
    ...
    @ApiImplicitParams({
            @ApiImplicitParam(name = "Authorization", value = "Authorization token",
                    required = true, dataType = "string", paramType = "header")})
    @Override
    public ResponseEntity<ResponseMsg> update(@PathVariable("id") Long id, @RequestBody TeacherDTO dto) {
